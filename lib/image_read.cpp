...
**/
bool _has_ending(std::string const &full_string, std::string const &ending) {
...
/**
 * Read PNG image file, get pixel RGB values, put them into the image object.
 * https://gist.github.com/niw/5963798
**/
image _png_read(const std::string &fname) {
...
image read_image(const std::string& fname) {
    if(_has_ending(fname, ".png") || _has_ending(fname, ".PNG"))
        return _png_read(fname);
